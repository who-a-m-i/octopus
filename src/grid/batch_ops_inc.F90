...
subroutine X(batch_get_points)(this, sp, ep, psi)
  ...
  case(BATCH_DEVICE_PACKED)
    call message_g%not_implemented('batch_get_points for CL packed batches')
  end select
...
subroutine X(batch_set_points)(this, sp, ep, psi)
  ...
  case(BATCH_DEVICE_PACKED)
    call message_g%not_implemented('batch_set_points for CL packed batches')
  end select
...
#else
    call message_g%not_implemented("OpenCL batch_mul")
#endif
