...
#else
            messages(1) = "Internal error: cannot call dsubmesh_batch_add_matrix with complex batch ss"
...
#else
        messages(1) = "Internal error: cannot call dsubmesh_batch_add with complex batch ss"
        call message_g%fatal(1)
#endif
...
#else
            messages(1) = "Internal error: cannot call dsubmesh_batch_dotp_matrix with complex batch ss"
            call message_g%fatal(1)
#endif
