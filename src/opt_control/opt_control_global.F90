...
contains
  ...
  subroutine oct_read_inp(oct, namespace)
    ...
    call message_g%print_stress(stdout, "OCT run mode")
    call message_g%obsolete_variable(namespace, 'OCTControlRepresentation')
    ...
    if(.not.varinfo_valid_option('OCTScheme', oct%algorithm)) call message_g%input_error('OCTScheme')
    ...
    call message_g%print_var_option(stdout, "OCTScheme", oct%algorithm)
    ...
    call message_g%print_var_value(stdout, "OCTDoubleCheck", oct%oct_double_check)
    ...
    call message_g%print_var_value(stdout, "OCTCheckGradient", oct%check_gradient)
    ...
    call message_g%print_var_value(stdout, "OCTDirectStep", oct%direct_step)
    ...
    call message_g%print_var_value(stdout, "OCTNumberCheckPoints", oct%number_checkpoints)
    ...
    call message_g%print_var_value(stdout, "OCTRandomInitialGuess", oct%random_initial_guess)
