...
subroutine X(modelmb_density_matrix_write)(gr, st, wf, mm, denmat, namespace)
  ...
  densmat_loop: do idensmat = 1, denmat%ndensmat_to_calculate
    ...
    write (messages_lines(1),'(a,I6,a,I6,a,I6)') 'For particle ', ikeeppart, ' of mb state ', mm
    write (messages_lines(2),'(a,3E20.10)') 'The dipole moment is (in a.u. = e bohr):     ', dipole_moment(1:min(3,ndim1part))
    write (messages_lines(3),'(a,E15.3)') '     with intrinsic numerical error usually <= ', 1.e-6*mb_1part%npt
