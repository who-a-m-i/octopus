...
contains
  ...
  ! ---------------------------------------------------------
  subroutine states_elec_init(st, parser, gr, geo)
    ...
    call states_elec_read_initial_occs(st, parser, excess_charge, gr%sb%kpoints)
    call states_elec_read_initial_spins(st, parser)
  ...
  subroutine states_elec_read_initial_occs(st, parser, excess_charge, kpoints)
  ...
  !! block is present.
  subroutine states_elec_read_initial_spins(st, parser)
    type(states_elec_t), intent(inout) :: st
    type(parser_t),      intent(in)    :: parser
...
!!$!!!!ENDOFDEBUG
  ...
  subroutine states_elec_exec_init(st, parser, mc)
    type(states_elec_t),    intent(inout) :: st
    type(parser_t),    intent(in)    :: parser
  ...
  ! ---------------------------------------------------------
  subroutine states_elec_distribute_nodes(st, parser, mc)
    type(states_elec_t),    intent(inout) :: st
    type(parser_t),         intent(in)    :: parser
    type(multicomm_t),      intent(in)    :: mc
  ...
  subroutine states_elec_count_pairs(st, parser, n_pairs, n_occ, n_unocc, is_included, is_frac_occ)
    type(states_elec_t),    intent(in)  :: st
    type(parser_t),         intent(in)  :: parser
