  ...
  eigenfunction_loop : do ist = converged + 1, st%nst
    ...
    iter_loop: do iter = 1, maxter
      ...
      if( sqrt(abs(gg)) < M_EPSILON ) then
        ...
        if(debug%info) then
          write(messages(1), '(a,i4,a,i4,a,i4,a,es13.6,a,i4)') 'Debug: CG Eigensolver - ik', ik, &
      ...
      if(debug%info .and. first_delta_e > M_ZERO) then
        write(messages(1), '(a,i4,a,i4,a,i4,a,es12.5,a,es12.5,a,i4)') 'Debug: CG Eigensolver - ik', ik, ' ist ', ist, &
  ...
  states: do ist = conv + 1, nst
    ...
    band: do i = 1, maxter - 1 ! One operation has already been made.
      ...
      if(debug%info) then
        ...
        write(messages(1), '(a,i4,a,i4,a,i4,a,es13.6,a,es13.6)') 'Debug: CG New Eigensolver - ik', ik, &
