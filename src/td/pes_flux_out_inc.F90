...
subroutine pes_flux_dump(restart, this, mesh, st, ierr)
  ...
  if(debug%info) then
    messages(1) = "Debug: Writing pes_flux restart."
  ...
  if(debug%info) then
    messages(1) = "Debug: Writing pes_flux restart done."
    call message_g%info(1)
  end if
...
subroutine pes_flux_load(restart, this, mesh, st, ierr)
  ...
  if(debug%info) then
    messages(1) = "Debug: Reading pes_flux restart."
    call message_g%info(1)
  end if
  ...
  if(debug%info) then
    messages(1) = "Debug: Reading pes_flux restart done."
    call message_g%info(1)
  end if
